...
const DESIGN_STYLES = [
    {
        ...
        color_palette: {
            primary: ['#F7F4EF', '#E0D6C8', '#1C1C1E'],
            accent:  ['#3A74B0', '#C4631A', '#2D7A5C'],
            neutral: ['#FAFAFA', '#EBEBEB', '#6B6B6B'],
            wall_suggestion: 'Warm greige (Asian Paints Apricot White or Berger Silk Linen) with one feature wall in deep charcoal (#1C1C1E) or petrol teal',
            hex_map: {
                'Cloud White':    '#F7F4EF',
                'Greige':         '#E0D6C8',
                'Off Black':      '#1C1C1E',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#7D3C0F', '#C49A22', '#5E1D2E'],
            accent:  ['#E8593A', '#D4AF37', '#2A6B35'],
            neutral: ['#EDD9B0', '#C8A87A', '#F5EDD8'],
            wall_suggestion: 'Deep terracotta (#7D3C0F), rich ochre (#C49A22), or crimson maroon (#5E1D2E) — Asian Paints Heritage / Nerolac Impressions',
            hex_map: {
                'Burnt Sienna':   '#7D3C0F',
                'Antique Gold':   '#C49A22',
                'Crimson Maroon': '#5E1D2E',
                'Saffron Coral':  '#E8593A',
                'Temple Gold':    '#D4AF37',
                'Deep Green':     '#2A6B35',
                'Pale Wheat':     '#EDD9B0',
                'Camel':          '#C8A87A',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#4A2610', '#9B6B0A', '#720000'],
            accent:  ['#CF4020', '#D4AF37', '#1A5C2A'],
            neutral: ['#EDE4CE', '#CCA97A', '#F5EDDC'],
            wall_suggestion: 'Ivory cream (#EDE4CE) walls with rust-red pillar accents and brass trims — Asian Paints Ivory White or Berger Silk Linen',
            hex_map: {
                'Dark Teak':      '#4A2610',
                'Antique Brass':  '#9B6B0A',
                'Temple Red':     '#720000',
                'Kumkum':         '#CF4020',
                'Brass Gold':     '#D4AF37',
                'Leaf Green':     '#1A5C2A',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#1E0F06', '#7A6045', '#3D5219'],
            accent:  ['#B01030', '#D4AF37', '#C96010'],
            neutral: ['#F0EDDA', '#DDD0B8', '#FDFCF0'],
            wall_suggestion: 'Traditional lime white (#F0EDDA) walls with dark jackwood (#1E0F06) frames — natural local lime wash or Asian Paints WeatherCoat',
            hex_map: {
                'Jackwood':       '#1E0F06',
                'Coir Tan':       '#7A6045',
                'Palm Green':     '#3D5219',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#B50000', '#E07010', '#004D2A'],
            accent:  ['#C9A800', '#7A1F9E', '#008BA8'],
            neutral: ['#FFF3C8', '#EDD9A0', '#FFFDE0'],
            wall_suggestion: 'Crimson red (#B50000), peacock teal (#008BA8), or saffron amber (#E07010) with ivory (#FFF3C8) borders and gold stencil accents',
            hex_map: {
                'Royal Crimson':  '#B50000',
                'Saffron Amber':  '#E07010',
                'Haveli Green':   '#004D2A',
                'Temple Gold':    '#C9A800',
                'Amethyst':       '#7A1F9E',
                'Peacock Teal':   '#008BA8',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#F5F2EB', '#E0DAC8', '#3C2C1C'],
            accent:  ['#E05A15', '#3E9957', '#1A72BA'],
            neutral: ['#FAFAF5', '#EDECE4', '#7A7570'],
            wall_suggestion: 'Cream (#F5F2EB) in N/E zones; warm yellow in SE kitchen; sage green (#3E9957) in North; ocean blue (#1A72BA) in West',
            hex_map: {
                'Vastu Cream':    '#F5F2EB',
                'Linen':          '#E0DAC8',
                'Earth Brown':    '#3C2C1C',
                'Energy Orange':  '#E05A15',
                'Growth Green':   '#3E9957',
                'Water Blue':     '#1A72BA',
                'Pure White':     '#FAFAF5',
                'Off White':      '#EDECE4',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#FAFAFA', '#F0EFF0', '#242424'],
            accent:  ['#D32F2F', '#1E6DB5', '#E59A00'],
            neutral: ['#E8ECEF', '#B8BFC4', '#697880'],
            wall_suggestion: 'Bright white (#FAFAFA) throughout for space illusion; one bold accent wall in cobalt (#1E6DB5) or bold red (#D32F2F)',
            hex_map: {
                'Bright White':   '#FAFAFA',
                'Cool White':     '#F0EFF0',
                'Charcoal':       '#242424',
    ...
    },
    {
        ...
        color_palette: {
            primary: ['#FEFCFA', '#F2EDE6', '#404040'],
            accent:  ['#D49060', '#7A6245', '#3E8E4A'],
            neutral: ['#EAE4DC', '#D4CCC0', '#9A9285'],
            wall_suggestion: 'Snow white (#FEFCFA) or warm linen (#F2EDE6) — Berger Silk Linen / Asian Paints Broken White — with jute & macramé wall art',
            hex_map: {
                'Snow White':     '#FEFCFA',
                'Linen':          '#F2EDE6',
